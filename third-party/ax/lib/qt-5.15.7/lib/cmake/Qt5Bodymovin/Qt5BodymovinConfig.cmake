...
set(Qt5Bodymovin_VERSION_STRING 5.15.7)
...
if (NOT TARGET Qt5::Bodymovin)
    ...
    set(Qt5Bodymovin_PRIVATE_INCLUDE_DIRS
        "${_qt5Bodymovin_install_prefix}/include/QtBodymovin/5.15.7"
        "${_qt5Bodymovin_install_prefix}/include/QtBodymovin/5.15.7/QtBodymovin"
    )
    ...
    foreach(_module_dep ${_Qt5Bodymovin_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.7 ${_Qt5Bodymovin_FIND_VERSION_EXACT}
    ...
    _populate_Bodymovin_target_properties(RELEASE "libQt5Bodymovin.so.5.15.7" "" FALSE)
